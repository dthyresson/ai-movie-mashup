// Generated by Wrangler by running `wrangler types` (hash: cc49b2a9dff6252d02436573917e10dd)
...
declare namespace Cloudflare {
	interface Env {
		...
		MASHUP_AGENT: DurableObjectNamespace<import("./src/worker").MashupAgent>;
		R2: R2Bucket;
		DB: D1Database;
		QUEUE: Queue;
		AI: Ai;
		ASSETS: Fetcher;
		MASHUP_WORKFLOW: Workflow;
	}
}
